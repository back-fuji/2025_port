...
export const MainContainerSection = (): JSX.Element => {
  return (
    <section className="flex flex-col min-h-[708px] items-start relative w-full bg-[#1a1a1a]">
      <div className="flex flex-col items-center justify-center pt-24 pb-12 px-6 relative flex-1 w-full bg-[#00000080]">
      ...
      <div className="flex flex-col items-center gap-2 absolute left-1/2 -translate-x-1/2 bottom-8 translate-y-[-1rem] animate-fade-in opacity-0 [--animation-delay:600ms]">
